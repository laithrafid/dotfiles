...
#   Set Paths
#   ------------------------------------------------------------
    export PATH="/Users/laithrafid/dotfiles/bin:/opt/metasploit-framework/bin/:/usr/local/sbin:/usr/local/bin/:/Users/laithrafid/Library/Python/3.10/bin/:$(go env GOPATH)/bin:$PATH"
...
alias code='code --reuse-window'                           # code:         Opens and file or dir in VSCode 
